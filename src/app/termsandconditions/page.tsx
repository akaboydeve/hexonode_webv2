        ...
        <section className="py-20 bg-gray-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-400">Please read our terms and conditions carefully</p>
                </div>
                ...
                <div className="bg-gray-800 rounded-xl p-8 shadow-lg">
                    ...
                    <div className="text-white space-y-6">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-400">Last updated on 31-03-2025 21:14:35</p>
                        </div>
                        ...
                        <div className="prose prose-invert max-w-none">
                            ...
                            <h3 className="text-xl font-semibold text-white mt-8 mb-4">Terms of Use</h3>
                            ...
                            <h3 className="text-xl font-semibold text-white mt-8 mb-4">Refund Policy</h3>
                            <p className="text-gray-300 leading-relaxed">
                                You understand that upon initiating a transaction for availing the Services you are entering into a legally binding and enforceable contract with us for the Services. You shall be entitled to claim a refund of the payment made by you in case we are not able to provide the Service. The timelines for such return and refund will be according to the specific Service you have availed or within the time period provided in our policies (as applicable). In case you do not raise a refund claim within the stipulated time, than this would make you ineligible for a refund.
                            </p>

                            <h3 className="text-xl font-semibold text-white mt-8 mb-4">Force Majeure</h3>
                            <p className="text-gray-300 leading-relaxed">
                            ...
                            <h3 className="text-xl font-semibold text-white mt-8 mb-4">Governing Law</h3>
                            <p className="text-gray-300 leading-relaxed">
                                These Terms and any dispute or claim relating to it, or its enforceability, shall be governed by and construed in accordance with the laws of India. All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in South 24 paragana, West Bengal.
                            </p>
